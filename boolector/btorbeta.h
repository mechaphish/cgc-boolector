...
BtorNode * btor_beta_reduce_merge (Btor * btor, BtorNode * exp,
                                   BtorPtrHashTable * merge_lambdas);

BtorNode * btor_beta_reduce_partial (Btor * btor, BtorNode * exp,
...
BtorNode * btor_apply_and_reduce (Btor * btor, int argc, BtorNode ** args,
                                  BtorNode * fun);
